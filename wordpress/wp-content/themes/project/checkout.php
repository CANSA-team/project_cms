...
?>
<?php get_header() ?>
<?php if (is_user_logged_in() && $cart['totall_Sub'] != 0) { ?>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div id="thong-bao" style="width: 100%;"></div>
                </div>
            </div>
        </div>
    </section>
        ...
        function prossecing() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    document.querySelector('.thm-btn').classList.add('btn-disabled');
                    document.getElementById('thong-bao').innerHTML = `<div class="alert alert-success" role="alert">Đặt hàng thành công!</div>`;
...
<?php } else if ($cart['totall_Sub'] == 0) {
    echo '<div style="height: 100px; width:100%; top:150px;" class="container"><h3>Bạn chưa chọn một sản phẩm nào!!!</h1></div>';
} else {
    echo '<div style="height: 100px; width:100%; top:150px;" class="container"><h3>Bạn chưa đăng nhập hoặc đăng ký!!!</h1></div>';
} ?>
<?php get_footer() ?>