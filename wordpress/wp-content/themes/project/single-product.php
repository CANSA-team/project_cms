                ...
                <div class="product_detail_content">
                    ...
                    <div class="product-quantity-box">
                        <div class="quantity-box">
                            <button onclick="MinusBtn();" type="button" class="sub">-</button>
                            <input type="number" id="quality-product" value="1" />
                            <button  onclick="PlusBtn();" type="button" class="add">+</button>
                        </div>
                        <div class="addto-cart-box">
                            <button onclick="qualityAdd(<?php echo $id ?>);" class="thm-btn" type="submit">Add to Cart</button>
                        </div>
                    </div>
                    <script>
                        var qualityNow = 1;
                        function PlusBtn(){
                            var quality = document.getElementById('quality-product').value++;
                            var prevalue = quality + 1
                            qualityNow = prevalue;
                        }
                        function MinusBtn(){
                            if(document.getElementById('quality-product').value >=1){
                                var quality = document.getElementById('quality-product').value--;
                                var prevalue = quality - 1
                                qualityNow = prevalue;
                            }    
                        }
                        function qualityAdd(id){
                            addCart(id,qualityNow)
                        }
                    </script>
